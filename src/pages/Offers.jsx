...
useEffect(()=>{
  ...
  const getOffersData = async ()=>{
    setLoading(true)
    let value = `&price_greater_than=1&price_less_than=5${selectedOption}`
...
return (
  <div>
    ...
    <div className="mainContainer">
      ...
      {(loading) ?
          <div style={{margin:"20px", fontSize:"4vw", fontWeight:500}}> Loading... </div> : (flag) ? <CardData response={OffersData} /> : <h1 style={{margin:"20px", fontSize:"4vw", fontWeight:500}}> Result Not Available, Please Search another data</h1>}
