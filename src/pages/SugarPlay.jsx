...
useEffect(()=>{
  const getSugarPlayData = async ()=>{
    setLoading(true)
    let value = `lip_liner${selectedOption}`
...
return (
  <div>
    ...
    <div className="mainContainer">
      ...
      {(loading) ?
          <div style={{margin:"20px", fontSize:"4vw", fontWeight:500}}> Loading... </div> : (flag) ? <CardData response={SugarPlayData} /> : <h1 style={{margin:"20px", fontSize:"4vw", fontWeight:500}}> Result Not Available, Please Search another data</h1>}
